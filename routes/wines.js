...
mongo.Db.connect(mongoUri, function(err, database){
  if (!err) {
    ...
    database.collection('wines', {strict:true}, function(err, collection){
      if (err){
        console.log('the wines collection does not exist. Creating it.');
        populateDB();
      }  
    });
  } else {
...
var populateDB = function() {
    ...
    db.collection('wines', function(err, collection) {
        ...
        //console.log('Removing the wines collection');
        //collection.remove();
